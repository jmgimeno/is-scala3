...
// To show all main methods in the project, use the following command in sbt
// sbt show discoverMainClasses
...
// sbt "runMain helloWorld4 patata poma pera"
